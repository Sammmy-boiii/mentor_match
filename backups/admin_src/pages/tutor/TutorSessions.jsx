...
const TutorSessions = () => {
  const { tToken, sessions, getSessions, completeSession, cancelSession } =
  ...
  return (
    <div className="m-5 w-full max-w-6xl sm:ml-72">
      <h2 className="text-xl font-semibold text-gray-700 mb-4">All Sessions</h2>

      <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        {/* Table Header */}
        <div className="hidden sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_2fr_1fr_1fr] gap-4 py-4 px-6 bg-gray-50 border-b border-gray-100 font-medium text-gray-600 text-sm">
          <p>#</p>
          <p>Student</p>
          <p>Payment</p>
          <p>Amount</p>
        ...
        <div className="divide-y divide-gray-100">
          {sessions && sessions.length > 0 ? (
            sessions.map((item, index) => (
              <div
                key={index}
                className="flex flex-wrap sm:grid sm:grid-cols-[0.5fr_2fr_1fr_1fr_2fr_1fr_1fr] gap-4 items-center py-4 px-6 hover:bg-gray-50 transition-colors"
              >
                {/* Index */}

...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex lg:flex-col lg:bg-[#1e293b] lg:w-64 lg:fixed lg:left-4 lg:top-8 lg:bottom-4 lg:rounded-xl lg:text-white lg:z-40 lg:p-0">
        {/* Logo */}
      ...
      {/* Mobile Navbar */}
      {tToken && !aToken && (
        <div className="lg:hidden fixed top-0 left-0 right-0 bg-[#1e293b] text-white flex flex-col items-center z-50">
          {/* Logo */}
